...
from ANN import MyMLPClassifier
...
if __name__ == '__main__':
    ...
    classifier = MyMLPClassifier(hidden_layer_sizes=(20,), activation='relu', max_iter=100,
                                 verbose=10, random_state=1, learning_rate_init=.03)
